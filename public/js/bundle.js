...
},{"./views/components/Main.react":157,"react":155}],157:[function(require,module,exports){
/** @jsx React.DOM */
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "chat-app-holder"}, 
                React.createElement(TopControls, {onUserAdded: this.onUserAdded}), 
...
},{"./TopControls.react":158,"./Users.react":160,"react":155}],158:[function(require,module,exports){
/** @jsx React.DOM */

var React = require('react');

module.exports = TopControls = React.createClass({displayName: "TopControls",
        ...
        return (
            React.createElement("div", {className: "controls-holder"}, 
                React.createElement("form", {onSubmit: this.onFormSubmit}, 
                    React.createElement("input", {type: "submit", className: "form-control", value: "Add..."})
                )
            )
            );
    }
...
module.exports = User = React.createClass({displayName: "User",
    onClick: function () {
        console.log(arguments);
    },
    render: function(){
        ...
        return (
            React.createElement("li", {className: "message-item"}, 
                React.createElement("span", {className: "user"}, user), 
                React.createElement("span", {onClick: this.onClick}, "Click")
            )
            )
    }
});
...
module.exports = Users = React.createClass({displayName: "Users",
    ...
    render: function(){
        ...
        return (
            React.createElement("ul", {className: "messages-holder"}, content)
            )
    }
});

},{"./User.react.js":159,"react":155}],161:[function(require,module,exports){
